...
*Develop Haskell based applications.*

| Metadata | Value |
|----------|-------|
| *Contributors* | Fiona Buckner |
| *Definition type* | Dockerfile |
| *Available image versions* | 8, 8.10, 8.10.2 |
...
While the definition itself works unmodified, you can select the version of Go the container uses by updating the `VERSION` arg in the included `devcontainer.json` (and rebuilding if you've already created the container).
